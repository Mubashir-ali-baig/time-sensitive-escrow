...
contract DeployEscrowV1 is Script {
    function run(uint256 _escrowInterval, address _owner) public returns (EscrowV1) {
        EscrowV1 escrowV1 = deployEscrowV1(_escrowInterval, _owner);
        return escrowV1;
    }

    function deployEscrowV1(uint256 _escrowInterval, address _owner) public returns (EscrowV1) {
        vm.startBroadcast();
